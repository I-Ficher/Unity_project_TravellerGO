...
public class CaptureSceneUIManager : MonoBehaviour
{
    ...
    void Update()
    {
        switch (manager.Status)
        {
            case CaptureSceneStatus.InProgress:
                HandleInProgress();
                break;
            case CaptureSceneStatus.Successfull:
                HandSuccessfull();
                
                break;
            case CaptureSceneStatus.Fail:
                HandleFailure();
    ...
    {
        successScreen.SetActive(manager.Status == CaptureSceneStatus.Successfull);
        failScreen.SetActive(manager.Status == CaptureSceneStatus.Fail);
